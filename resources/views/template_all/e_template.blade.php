        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                        <a href="{{route('product')}}"><i class="menu-icon fa fa-table"></i>Semua Produk</a>
                    </li>
                    <li class="">
                        <a href="{{route('addproduct')}}"><i class="menu-icon fa fa-plus"></i>Tambah Produk</a>
                    </li>
                    <li class="menu-title">Order</li><!-- /.menu-title -->
                    <li class="">
                        <a href="{{route('admin.orders')}}"><i class="menu-icon fa fa-cart-arrow-down"></i>
                            Pesanan Masuk
                    ...
                    <li class="">
                        <a href="{{route('admin.pesanansiap')}}"><i class="menu-icon fa fa-shopping-cart"></i>
                            Pesanan Siap
                            <span class="badge rounded-circle badge-notification text-light" style="background-color: #2FDBBC;">
